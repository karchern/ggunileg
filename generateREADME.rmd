...
To fix this I offer the `scale_color_highres` function as a convenience function. The number of distinct shape levels can be controlled using the `numShapeLevels` parameter. Note how the color_label variable is mapped to both color and shape aesthetics here.
